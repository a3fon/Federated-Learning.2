...
#     """
#     Splitting provided trainset into nclients respective
#     clients objects, ensuring each gets exactly one sample.
#     """
#     if len(trainset) < nclients:
#         raise ValueError("Not enough data samples to allocate one per client.")
#
#     # Ensure each client gets exactly one sample
#     split_list = [1] * nclients
#     client_data = random_split(trainset, split_list)
#     client_list = []
#
#     for i, dataset in enumerate(client_data):
